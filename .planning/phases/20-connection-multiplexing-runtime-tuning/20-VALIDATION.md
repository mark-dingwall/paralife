...
| 20-01b-1b.0 | 01b (baseline JFR capture at c22e487) | 1 | SCALE-09 | — | Artifacts present; size < 10 MB each | manual | `ls .../profiles/jfr-{100,500,1000}bots-baseline-c22e487.jfr ...` + three-gate stack | ✅ (superseded) | superseded by 20-01c |
| 20-01b-1b.1 | 01b (verify baseline + write summary) | 1 | SCALE-09 | — | SUMMARY.md exists | regression | same artifact existence + three-gate | ✅ (superseded) | superseded by 20-01c |
...
| 20-03-3.2 | 03 — paralife.runtime.app.* yaml block + regression | 3 | SCALE-09 | — | outbound-queue-size alongside, not moved (D-20) | regression | `grep -A30 "^  runtime:" src/main/resources/application.yml \| grep -q "    app:" && ... --tests AppRuntimeConfigTest --tests GoldenTraceEquivalenceTest --tests GoldenTraceWithActionsTest --tests LiveEntityRegistryInvariantTest` | ✅ | ✅ green |
| 20-04-4.1 | 04 — 20-RUNTIME.md skeleton §1,§2,§5,§6 | 3 | SCALE-09 | — | doc-only; no code change | manual | `test -f .planning/phases/20-connection-multiplexing-runtime-tuning/20-RUNTIME.md && grep -q "## §1 Architectural Principle: WS:entity 1:1" ... && grep -q "## §6 Profile Index" ...` | ✅ | ✅ green |
...
| 20-06-6.1 | 06 — Finalise 20-RUNTIME.md §4.3 + §4.2 100/500 + §6 index | 5 | SCALE-08, SCALE-09 | — | Zero pending markers; §4.3 all tiers present; §6 complete | manual + regression | `test -f .planning/phases/20-connection-multiplexing-runtime-tuning/20-RUNTIME.md && grep -q "## §4.3 Per-tier narrative" .../20-RUNTIME.md && grep -qE "jfr-1000bots-active-50xfood-(103a615\|tuned-424e06d)" .../20-RUNTIME.md && grep -q "metrics-1000bots-active-50xfood-103a615" .../20-RUNTIME.md && grep -q "metrics-1000bots-active-50xfood-tuned-424e06d" .../20-RUNTIME.md` | ✅ | ✅ green (commit `6be125e`) |
