...
Cross-reference: `CLAUDE.md §Connection model`; `17-ADMISSION.md §3` (FSM diagram).
...
- A new `r|` grammar slot — `15-SCHEMA.md` §6.1 is milestone-locked; no codec change.
...
*Cross-references: `17-ADMISSION.md` §1 (token taxonomy), `15-SCHEMA.md` §6.1 (`r|` grammar).*
