...
**Milestones:** v1.0 Foundation (Phases 01–10) ✅ · v2.0 Combination & Emergence (Phases 11–16) ✅ · v3.0 Scale Engineering (Phases 17–22) 🚧 active — latest sequenced phase complete is Phase 20.1; Phase 21 (scale benchmark gate) is next. Phase history, the decision registers, and per-phase detail are frozen under `.planning/` (see `.planning/README.md`).
