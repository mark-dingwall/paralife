...
|---|------|-------|----------|--------|-----------|------------|
| D001 | M001 | arch | Client-server connectivity | WebSocket | Persistent connections, server pushes tick events, natural fit for real-time simulation. Showcases skills relevant to Canva's real-time collaboration. | Yes |
